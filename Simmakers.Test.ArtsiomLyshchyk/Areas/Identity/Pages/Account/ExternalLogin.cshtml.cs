...
namespace Simmakers.Test.ArtsiomLyshchyk.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
        ...
        private BaseUser CreateUser()
        {
            ...
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(BaseUser)}'. " +
                    $"Ensure that '{nameof(BaseUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
